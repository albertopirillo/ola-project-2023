...
if __name__ == '__main__':
    ...
    plot_statistics(inst_reward_ucb1, inst_regret_ucb1, 'UCB1 & GP-UCB', 'Step 4.1 - Context known')
    plot_statistics(inst_reward_ts, inst_regret_ts, 'TS & GP-TS', 'Step 4.1 - Context known')
    plt.tight_layout()
    plt.show()
