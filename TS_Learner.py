...
class TS_Learner(Learner):
    ...
    def update(self, pulled_arm, reward):
        self.t += 1  # update the number of round
        self.update_observations(pulled_arm, reward)  # update the observation of the pulled arm
        self.beta_parameters[pulled_arm, 0] = self.beta_parameters[pulled_arm, 0] + reward  # first beta parameter counts the number of successes
