...
def run_experiment(_):
    ...
    return instantaneous_reward_clairvoyant, instantaneous_reward_exp3, \
        ...
        instantaneous_regret_exp3, instantaneous_regret_sw_ucb, instantaneous_regret_cd_ucb
...
if __name__ == '__main__':
    ...
    inst_regret_exp3 = results_array[:, 5, :]
    ...
    plot_statistics(inst_reward_sw_ucb, inst_regret_sw_ucb, 'SW-UCB1', 'Step 6.1')
    plot_statistics(inst_reward_cd_ucb, inst_regret_cd_ucb, 'CD-UCB1', 'Step 6.1')
    plt.tight_layout()
    plt.show()
